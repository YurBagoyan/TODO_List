...
#include <memory>
#include "../../../ToDoList_QtProject/taskitemwidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TaskItemWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TaskItemWidget_t qt_meta_stringdata_TaskItemWidget = {
    {
        QT_MOC_LITERAL(0, 14)   // "TaskItemWidget"
    },
    "TaskItemWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_TaskItemWidget[] = {
...
Q_CONSTINIT const QMetaObject TaskItemWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_TaskItemWidget.offsetsAndSizes,
    qt_meta_data_TaskItemWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TaskItemWidget_t,
        // Q_OBJECT / Q_GADGET
